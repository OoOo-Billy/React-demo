...
export default class TodoApp extends Component {
  constructor(){
    super();
    this.state = localStorage.todoList ?  {todoList: JSON.parse(localStorage.todoList)} : {todoList:[]}
    this.state = {
  ...
  render(){
    return(
      <div className="wrapper">
        ...
        <TodoList todoList={this.state.todoList} remove={this.handleRemoveTodo.bind(this)} handleDoneOne={this.handleDoneOne.bind(this)}/>
        <TodoFooter done={this.state.done} total={this.state.todoList.length} handleAllDone={this.handleAllDone.bind(this)} handleCheckedAll={this.handleCheckedAll.bind(this)}/>
      </div>
    )
  }
}